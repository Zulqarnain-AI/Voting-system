...
class AddCandidateWindow extends JFrame {
    public AddCandidateWindow() {
        ...
        // Create components
        JLabel titleLabel = new JLabel("Add Candidate");
        ...
        addButton.addActionListener(e -> {
            ...
            if (!Registration.addCandidate(id, name)) {
                JOptionPane.showMessageDialog(this, "Candidate ID already exists!", "Error", JOptionPane.ERROR_MESSAGE);
            } else {
